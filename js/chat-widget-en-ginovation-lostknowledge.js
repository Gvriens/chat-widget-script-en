// Interactive Chat Widget for n8n, converted by Ginovation - Lostknowledge (English Version - Customized Colors and Branding)
(function() {
   ...
   // Load font resource - Poppins for a fresh look
   ...
   // Apply widget styles with a completely different design approach
   const widgetStyles = document.createElement('style');
   widgetStyles.textContent = `
       .chat-assist-widget {
           --chat-color-primary: var(--chat-widget-primary, #3985B2); /* New primary color */
           --chat-color-secondary: var(--chat-widget-secondary, #103A52); /* New secondary color */
           --chat-color-tertiary: var(--chat-widget-tertiary, #103A52); /* New tertiary color (same as secondary) */
           --chat-color-light: var(--chat-widget-light, #e0f2f7); /* Light blue/grey tone, matching the new primary color */
           --chat-color-surface: var(--chat-widget-surface, #ffffff);
           --chat-color-text: var(--chat-widget-text, #1f2937);
           --chat-color-text-light: var(--chat-widget-text-light, #6b7280);
           --chat-color-border: var(--chat-widget-border, #e5e7eb);
           --chat-shadow-sm: 0 1px 3px rgba(57, 133, 178, 0.1); /* Custom shadow color (rgba of #3985B2) */
           --chat-shadow-md: 0 4px 6px rgba(57, 133, 178, 0.15); /* Custom shadow color (rgba of #3985B2) */
           --chat-shadow-lg: 0 10px 15px rgba(57, 133, 178, 0.2); /* Custom shadow color (rgba of #3985B2) */
           --chat-radius-sm: 8px;
           --chat-radius-md: 12px;
           --chat-radius-lg: 20px;
       ...
       .chat-assist-widget .chat-messages::-webkit-scrollbar-thumb {
           background-color: rgba(57, 133, 178, 0.3); /* Custom scrollbar color (rgba of #3985B2) */
           border-radius: var(--chat-radius-full);
       }
       ...
       .chat-assist-widget .chat-textarea:focus {
           ...
           box-shadow: 0 0 0 3px rgba(57, 133, 178, 0.2); /* Custom focus shadow (rgba of #3985B2) */
       }
   ...
   const defaultSettings = {
       ...
       branding: {
           logo: '',
           name: '',
           welcomeText: 'Hi! How can I help you?', // EN: Welcome text
           responseTimeText: 'Response usually within a few minutes', // EN: Response time text
           poweredBy: {
               text: 'Ginovation - Lostknowledge', // Custom 'Powered by' text
               link: 'https://1qr.nl/sh/SDpW5' // Custom 'Powered by' link
           }
       },
       style: {
           primaryColor: '#3985B2', // New primary color (blue)
           secondaryColor: '#103A52', // New secondary color (dark blue)
           position: 'right',
   ...
   const settings = window.ChatWidgetConfig ?
       {
           ...
           branding: {
               ...
               poweredBy: { // Ensure poweredBy is correctly overwritten
           ...
           style: {
               ...
               // Force new colors, regardless of previous settings
   ...
   widgetRoot.style.setProperty('--chat-widget-tertiary', settings.style.secondaryColor); // Tertiary color is now same as secondary
